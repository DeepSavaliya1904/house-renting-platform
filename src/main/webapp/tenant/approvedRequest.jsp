        ...
        <table class="table" style="margin-top: 60px;">
            ...
            <tbody>
				...
				<tr>
					...
					<td><%out.println(r2.getString("name")); %></td>
					<td><%out.println(r3.getString("address")); %></td>
					<td><%out.println(r3.getString("area")); %></td>
					<td><%out.println(r3.getString("num_of_bedrooms")); %></td>
					<td><%out.println(r3.getString("num_of_bathrooms")); %></td>			
					...
					<td>
						<form action="showDetails.jsp" method="POST">
							...
							<input type="hidden" name="owner_id" value="<%= r1.getString(3) %>">
							<input type="hidden" name="tenant_id" value="<%= r1.getString(2) %>">
							<input type="submit" value="showDetails" class="btn btn-outline-success me-3" style="margin-right:150px;">
						</form>
					</td>
				</tr>
					<% }
          ...
          <%
		    		try{
		    			...
		    			if(r.next()){
		    				...
		    				p4.setString(5,"show approved Request");
		    				p4.executeUpdate();
		    			}
		    		}catch(Exception e){
		    			e.printStackTrace();
