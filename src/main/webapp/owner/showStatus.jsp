            ...
            <tbody>
				<%
					try{
						...
						PreparedStatement p1=con.prepareStatement("select *from renting_details where owner_id=?");
						p1.setString(1,id);
						...
						while(r1.next()){
					        if (!("accept".equals(r1.getString("request")) || "reject".equals(r1.getString("request")))) {
					        	...
					        	if(r2.next()){   	
					        		PreparedStatement p3=con.prepareStatement("select *from tenant_details where tenant_id=?");
